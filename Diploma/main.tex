...
\comment{Starejše statistične metode, ki so se razcvetele v dobi računalništva.}



\subsection{Osnovni pregled značilk}
Osnovni pregled podatkov se nanaša na pregled po eni posamezni značilki. Zajema \textbf{pregled manjkajočih vrednosti} v podatkih, \textbf{pregled osnovnih agregatov} in natančnejši \textbf{pregled porazdelitev} določenih značilk s pomočjo histogramov.
...
\subsection{Razpršeni grafi}

\subsection{Korelacijska matrika značilk}
...
\subsection{Analiza glavnih komponent}
...
\comment{Predvideva neodvisnost značilk.}

\comment{Rabi malo podatkov za trening - ni nam nič v pomoč.}
...
\comment{Tole bi vseeno mogoče izpustil. Nekje dodam samo še preceision/recall, ki sta OK za lažje razumevanje dogajanja.}
